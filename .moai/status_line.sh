...
if [ -f "/Users/rohyeongseo/go/bin/moai" ]; then
	exec "/Users/rohyeongseo/go/bin/moai" statusline < "$temp_file"
fi

# Try user local bin directory
if [ -f "/Users/rohyeongseo/.local/bin/moai" ]; then
	exec "/Users/rohyeongseo/.local/bin/moai" statusline < "$temp_file"
fi
