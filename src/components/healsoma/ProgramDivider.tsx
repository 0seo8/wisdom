...
export function ProgramDivider() {
  return (
    <section className="relative overflow-hidden px-5 pb-5 pt-10 md:px-0 md:py-[60px]">
      <div
      ...
      <div className="relative z-20 text-center">
        <h2 className="hero-font-times text-[38px] font-semibold text-white md:text-[70px]">
          PROGRAM
        </h2>
      </div>
    </section>
