      ...
      <div className="container">
        ...
        >
          ...
          <p className="text-gray-600 text-lg leading-relaxed">
            웰니스는 자신을 제대로 아는 것부터 시작됩니다. 소매틱랩은 동양의
            철학과 심리학, 서양의 뇌과학을 통합적으로 연구하여 널리 사람을
            이롭게하여 풍요로운 세상을 만듭니다.
          </p>
        </motion.div>
        ...
        >
          ...
          <div className="p-8 md:p-12 bg-gradient-to-br from-[var(--color-green-light)]/30 to-white rounded-3xl">
            ...
            <p className="text-gray-600 leading-relaxed">
              소매틱랩은 Holistic 관점의 소매틱을 연구하여 새로운 웰니스
              패러다임을 제시합니다.
              <br />
              <br />
              동양의 철학과 심리학, 서양의 뇌과학을 통합적으로 연구하여 다양한
              소매틱 접근법을 개발하고 전문가 양성 및 일반인 교육을 통해
              소매틱스를 널리 알립니다.
            </p>
          </div>
        </motion.div>
