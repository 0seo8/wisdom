...
const greetingParagraphs = [
  "행복한 삶을 위해서는 나 자신, 관계, 세상과의 균형이 필요합니다.",
  "지혜의밭은 '예술의 힘으로 본래의 인간성을 회복하여 삶의 터전을 지혜롭게 가꾼다'는 미션 아래, 몸과 마음의 건강을 돌보는 웰니스 프로그램을 개발하고 운영하고 있습니다.",
  "소매틱스를 기반으로 한 힐소마(HEALASOMA), 예술을 통한 소통과 공감의 일상의 예술, 그리고 기업과 조직을 위한 맞춤형 교육까지 — 우리는 사람과 사람, 사람과 세상을 연결하는 다리가 되고자 합니다.",
  "건강한 사회를 위해, 지혜의밭이 함께하겠습니다.",
];
