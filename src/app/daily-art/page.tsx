          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <a
                ...
                className="inline-flex items-center justify-center px-8 py-4 bg-white text-[var(--color-blue)] border-2 border-[var(--color-blue)] font-medium rounded-full hover:bg-[var(--color-blue-light)] transition-colors duration-200"
              >
                브로슈어 바로가기
                <svg
                  className="w-5 h-5 ml-2"
